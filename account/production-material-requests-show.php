             ...
             <div>
             	<table>
                   <tr>
                      ...
                      <td width="120">Batch Number:</td><td width="340"><input type="text" value="<?php echo $request['batch_no']; ?>" class="text-field" disabled/></td>
                   </tr>
                   <tr>
                      ...
                      <td>Status:</td><td><input type="text" value="<?php echo $request['status']; ?>" class="text-field" disabled/></td>
                   </tr>
                   <tr>
