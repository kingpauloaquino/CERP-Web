...
function populate_records($keyword='', $page, $limit, $order, $sort) {
  ...
  $startpoint = $limit * ($page - 1);
	...
	$search = (isset($keyword) || $keyword != '') 
						...
						AND MONTH(shipment_plans.ship_date) ='.$_GET['smonth'].' AND shipment_plans.item_id='.$_GET['pid']
						: 'MONTH(shipment_plans.ship_date)='.$_GET['smonth'].' AND shipment_plans.item_id='.$_GET['pid'];
