...
function populate_records($keyword='', $page, $limit, $order, $sort) {
  ...
  $startpoint = $limit * ($page - 1);
	...
	$query = $DB->Fetch('shipment_plans', array(
							'columns'	=> 'shipment_plans.id, po_id, shipment_plans.item_id, shipment_plans.item_type, ship_date, qty, remarks, lookups.code AS unit, lookup_status.description AS completion',
