    ...
    <div id="content">
      <form id="purchase-order-form" action="<?php host($Capabilities->GetUrl()) ?>" method="POST" class="form-container">
      	 <input type="hidden" name="action" value="edit_purchase_order"/>
					<input type="hidden" id="purchase_order[id]" name="purchase_order[id]" value="<?php echo $_GET['pid'] ?>"/>
         <!-- BOF TEXTFIELDS -->
         <div>
         	<table>
               <tr>
               ...
               <tr>
                  <td>P/O Number:</td><td><input id="po_number" type="text" name="purchase_order[po_number]" value="<?php echo $purchase_order['order_no'] ?>" class="text-field magenta" notice="po_number_status" autocomplete="off" required/>
               ...
               <tr>
                  ...
                  <td>Ship Date:</td><td><input type="text" name="purchase_order[ship_date]" value="<?php echo date("F d, Y", strtotime($purchase_order['ship_date']))?>" class="text-field date-pick"/></td>
               </tr>
               <tr>
                  <td>Payment Terms:</td>
                  <td colspan="99">
         ...
         <div>
         	<table width="100%">
               ...
               <tr><td colspan="2">Remarks:<br/><textarea name="purchase_order[remarks]" style="min-width:650px;width:98.9%;height:50px;"><?php echo $purchase_order['remarks'] ?></textarea></td></tr>
            </table>
         </div>
         <div class="field-command">
       	   <div class="text-post-status">
       	     <strong>Save As:</strong>&nbsp;&nbsp;<select name="purchase_order[status]"><?php echo build_select_post_status("APRVL", $purchase_order['status_id']); ?></select>
           </div>
       	   <input id="submit-btn" type="submit" value="Save" class="btn"/>
           <input type="button" value="Cancel" class="btn redirect-to" rel="<?php echo host('purchase-orders-show.php?pid='.$_GET['pid']); ?>"/>
         </div>
      </form>
   </div>
       ...
       <script>
				$(function() {
			      ...
			      "limit":"50",
						...
						"row_template":"row_template_purchase_order_items",
					}
