        ...
        <button class="btn" onclick="return cancel_btn();">Cancel</button>
		  ...
		  <div id="add-part-modal" class="modal">
		   ...
		   <div class="modal-content">
		         ...
		         <div class="field">
		            <label>Unit:</label>
		            <input type="text" id="unit" name="unit" class=" text-field" readonly="readonly" />
		         </div>	
		         
		         <div class="field">
		            <label>Unit Price:</label>
		            <input type="text" id="cost" name="cost" class=" text-field" readonly="readonly" />
		         </div>			         
		         
		         <div class="field">
		            <label>Quantity:</label>
		            <input type="text" id="material_qty" name="material_qty" class=" text-field" autocomplete="off" />
		         </div>
			...
			<div class="modal-footer">
				...
				<a id="part-continue" class="part-submit-reset btn">Continue</a>
				<a id="part-add-close" class="part-submit-reset btn">Add & Close</a>
				<div class="clear"></div>
			</div>
		</div>
...
<script>
	$(document).ready(function(){
		...
		//$('#material_code').Watermark("Material Code");			
	});
