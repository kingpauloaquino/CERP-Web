	...
	<div id="page">
        ...
        <div class="form-container">
	        ...
	        <table>            
	           ...
	           <tr>
	           		<td width="150">Currency:</td><td width="310"><?php select_query_tag($currencies, 'id', 'description', '', 'item_cost[currency]', 'item_cost[currency]', '', 'width:192px;'); ?></td>
