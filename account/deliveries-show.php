      ...
      <div id="page">
        ...
        <div id="content">
          ...
          <form id="delivery-form" action="<?php host($Capabilities->GetUrl()) ?>" method="POST" class="form-container">
             ...
             <div>
             	<table>
                   <tr>
                      <td width="120">Delivery Receipt:</td><td width="340"><input type="text" name="delivery[receipt]" value="<?php echo $delivery['delivery_receipt']; ?>" disabled="disabled"/></td>
                   ...
                   <tr>
                      <td>Delivery Via:</td><td><input type="text" name="delivery[via]" value="<?php echo $delivery['delivery_via']; ?>" class="text-field" disabled="disabled"/></td>
                      <td>Delivery Date:</td><td><input type="text" name="delivery[date]" value="<?php echo dformat($delivery['delivery_date'], 'm/d/Y'); ?>" class="text-field text-date" disabled="disabled"/></td>
                   </tr>
                   <tr>
                      <td>Trade Terms:</td><td><input type="text" name="delivery[trade_terms]" value="<?php echo $delivery['trade_terms']; ?>" class="text-field" disabled="disabled"/></td>
                      <td>Payment Terms:</td><td><input type="text" name="delivery[payment_terms]" value="<?php echo $delivery['payment_terms']; ?>" class="text-field" disabled="disabled"/></td>
                   </tr>
             ...
             <div id="grid-purchase-materials" class="grid jq-grid" style="min-height:146px;">
               <table cellspacing="0" cellpadding="0">
                 <thead>
                   <tr>
                     <td width="20" class="border-right text-center"><input type="checkbox" class="chk-all" disabled="disabled"/></td>
             ...
             <div>
             	<table width="100%">
                   <tr><td height="5" colspan="99"></td></tr>
                   <tr><td colspan="2">Remarks:<br/><textarea name="delivery[remarks]" style="min-width:650px;width:98.9%;height:50px;" disabled="disabled"><?php echo $delivery['remarks']; ?></textarea></td></tr>
                </table>
             </div>
       ...
       <script>
        ...
        function row_template_verify_deliver_materials(data) {
          ...
          var row = $("<tr></tr>");
          var passed = $("<input type=\"checkbox\" name=\"\" disabled=\"disabled\"/>");
          
          if(data['passed'] == 1) passed.attr('checked', 'checked');
          
          row.append("<td class=\"border-right text-center\"><input type=\"checkbox\" class=\"chk-all\" disabled=\"disabled\"/></td>");
