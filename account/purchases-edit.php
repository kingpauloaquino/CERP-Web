      ...
      <div id="page">
            ...
            <div id="grid-materials" class="grid jq-grid">
               <table cellspacing="0" cellpadding="0">
                 <thead>
                   <tr>
                     <td width="20" class="border-right text-center"><input type="checkbox" class="chk-all"/></td>
                     <td width="110" class="border-right">Item Code</td>
                     <td width="90" class="border-right">Brand</td>
                     <td class="border-right">Description</td>
                     <td width="60" class="border-right text-center">Unit</td>
                     <td width="60" class="text-center">Price</td>
                   </tr>
                 </thead>
                 <tbody></tbody>
               </table>
       ...
       <script>
         $(function() {
           ...
           var data_materials = { 
             "url":"/populate/materials.php?limit=10",
             "data_key":"materials",
