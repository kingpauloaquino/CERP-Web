...
function populate_records($keyword='', $page, $limit, $order, $sort) {
  ...
  $startpoint = $limit * ($page - 1);
	...
	$search = (isset($keyword) || $keyword != '') 
						...
						AND MONTH(shipment_plans.prod_date) ='.$_GET['pmonth'].' AND shipment_plans.item_id='.$_GET['pid']
						: 'MONTH(shipment_plans.prod_date)='.$_GET['pmonth'].' AND shipment_plans.item_id='.$_GET['pid'];
	...
	return array("production_plan_all" => $query, "total" => $DB->totalRows());
}
