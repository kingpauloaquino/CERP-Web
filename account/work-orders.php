	...
	<div id="page">
      ...
      <div id="grid-work-orders" class="grid jq-grid" style="min-height:400px;">
        <table cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              <td class="border-right text-center" width="130"><a class="sort default active up" column="wo_number">W/O Number</a></td>
              <td class="border-right text-center" width="90"><a class="sort" column="wo_date">W/O Date</a></td>
              <td class="border-right"><a class="sort" column="description">Remarks</a></td>
              <td class="border-right text-center" width="90"><a class="sort" column="ship_date">Ship Date</a></td>
