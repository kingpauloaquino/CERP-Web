<?php
  /* Module: Work Orders - Edit  */
  $capability_key = 'edit_work_order';
  require('header.php');
...
?>
    ...
    <div id="content">
      <form id="order-form" action="<?php host($Capabilities->GetUrl()) ?>" method="POST" class="form-container">
      	 <input type="hidden" name="action" value="edit_work_order"/>
      	 <input type="hidden" name="work_order[id]" value="<?php echo $_GET['wid']; ?>"/>
         <!-- BOF TEXTFIELDS -->
         <div>
         	<table>
               <tr>
                  <td width="120">W/O Number:</td><td width="340"><input type="text" name="work_order[wo_number]" value="<?php echo $work_order['wo_number'] ?>" class="text-field magenta" disabled/></td>
         ...
         <div>
         	<table width="100%">
               ...
               <tr><td colspan="2">Remarks:<br/><textarea name="work_order[remarks]" style="min-width:650px;width:98.9%;height:50px;"><?php echo $work_order['remarks'] ?></textarea></td></tr>
            </table>
         </div>
       ...
       <script>
				$(function() {
			      ...
			      "limit":"50",
						...
						"row_template":"row_template_work_order_items",
					}
