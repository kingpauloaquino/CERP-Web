      ...
      <form id="order-form" action="<?php host($Capabilities->GetUrl()) ?>" method="POST" class="form-container">
         ...
         <div>
         	<table width="100%">
               ...
               <tr><td colspan="2">Remarks:<br/><textarea name="order[remarks]" style="min-width:650px;width:98.9%;height:50px;"></textarea></td></tr>
            </table>
         </div>
         <div class="field-command">
       	   <div class="text-post-status">
       	     <strong>Save As:</strong>&nbsp;&nbsp;<select name="order[status]"><?php echo build_select_post_status(); ?></select>
           </div>
       	   <input type="submit" value="Save" class="btn"/>
           <input type="button" value="Cancel" class="btn redirect-to" rel="<?php echo host('orders.php'); ?>"/>
         </div>
      </form>
   </div>
