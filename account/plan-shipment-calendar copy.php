      ...
      <div id="plan-weeks" style="display: none;">
	      ...
	      <div id="grid-products-week" class="grid jq-grid" style="min-height:140px;">
	        <table cellspacing="0" cellpadding="0" >
	          <thead>
	            <tr>
	              <td class="border-right text-center" width="120"><a class="sort default active up" column="code">Model</a></td>
	              <td class="border-right text-center" width="120"><a class="sort" column="ctrl_no">Ctrl No.</a></td>
	              <td class="border-right text-center" width="70"><a class="sort" column="type">Type</a></td>
	        ...
	        <table cellspacing="0" cellpadding="0" >
	          <thead>
	            <tr>
	              ...
	              <td class="border-right text-center" width="120"><a class="sort" column="code">Model</a></td>
	              <td class="border-right text-center" width="120"><a class="sort" column="ctrl_no">Ctrl No.</a></td>
	              <td class="border-right text-center" width="70"><a class="sort" column="type">Type</a></td>
	              <td class="border-right text-center" width="90"><a class="sort" column="series">Series</a></td>
	              <td class="border-right text-center" width="70"><a class="sort" column="pack">Pack</a></td>
